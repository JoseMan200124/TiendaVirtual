...
$titulosModulos = array("TRABAJOS DESTACADOS", "TRABAJOS INTERESANTES", "TRABAJOS MÁS VISTOS");
$rutaModulos = array("articulos-gratis","lo-mas-vendido","lo-mas-visto");

$base = 0;
$tope = 4;

if($titulosModulos[0] == "TRABAJOS DESTACADOS"){
...
if($titulosModulos[1] == "TRABAJOS INTERESANTES"){
...
if($titulosModulos[2] == "TRABAJOS MÁS VISTOS"){
							...
							<div class="col-xs-6 enlaces">
								...
								<div class="btn-group pull-right">
									...
									if($value["tipo"] == "virtual" && $value["precio"] != 0){
											...
											echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value["id"].'" imagen="'.$servidor.$value["portada"].'" titulo="'.$value["titulo"].'" precio="'.$value["precio"].'" tipo="'.$value["tipo"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
