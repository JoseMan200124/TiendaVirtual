						...
						<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
							...
							echo '<div class="btn-group pull-left enlaces">
						  		...
						  		if($value["tipo"] == "virtual" && $value["precio"] != 0){
											...
											echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value["id"].'" imagen="'.$servidor.$value["portada"].'" titulo="'.$value["titulo"].'" tipo="'.$value["tipo"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
